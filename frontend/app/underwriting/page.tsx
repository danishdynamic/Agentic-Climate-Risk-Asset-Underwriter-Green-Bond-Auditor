  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto px-4 py-2">
      ...
      <section aria-label="Page Header" className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/60 pb-4">
        ...
        <div className="flex items-center gap-2 self-start sm:self-center font-mono text-[11px] bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-lg px-3 py-1.5 shadow-2xs font-bold">
          <ShieldCheck className="h-3.5 w-3.5 text-emerald-500" />
          <span className="uppercase tracking-wider">Policy Framework: Active</span>
        </div>
      </section>
      ...
      >
        ...
        <div className="xl:col-span-3 order-2 xl:order-1 flex flex-col h-full">
          <div className="border border-emerald-500/10 dark:border-emerald-500/20 rounded-xl bg-emerald-500/[0.005] p-1 shadow-2xs hover:border-emerald-500/20 dark:hover:border-emerald-500/30 transition-all duration-300 h-full">
            <RiskScoreCard />
          </div>
        </div>
        ...
        <div className="xl:col-span-1 order-1 xl:order-2 w-full xl:sticky xl:top-6">
          <div className="space-y-2">
            <div className="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 font-semibold uppercase tracking-widest pl-1">
              Configuration Panel
            </div>
            <AuditCard />
          </div>
